...
* Craft and place linked chests
* All linked chests share a **single global inventory**
* Items can be inserted or removed from any linked chest
* Each chest includes a **built-in GUI** that makes managing items and settings easy
* Linked chests can be connected to the **logistic network** using **red or green circuit wires**
* Works across:
...
No belts, trains, bots, or rockets are required.
...
* ❌ Not recommended for progression-based or challenge-focused playthroughs
